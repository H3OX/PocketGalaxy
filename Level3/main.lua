...
local qy=0
local v=0
local music = audio.loadStream('music3.mp3')
...
star:scale(0.1, 0.1)
physics.addBody( star, "kinematic", { isSensor=true, radius=120 } )
    ...
    if ( event.phase == "began" and objectToPull.touchJoint == nil ) then
         timer.performWithDelay( 100,
            function()
                ...
                objectToPull.touchJoint.frequency = 0.3
                objectToPull.touchJoint.dampingRatio = 0.31
